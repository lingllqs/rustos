...
protect_mode_entry:
	...
	mov byte [0xb8000 + 6], 'K'
	mov byte [0xb8000 + 7], 0x0a
...
msg_kernel_loading: db "Loading Kernel...", 0x0a, 0x0d, 0x00
msg_memory_detected: db "Memory detected Success", 0x0a, 0x0d, 0x00
msg_kernel_loaded: db "Kernel Loaded", 0x0a, 0x0d, 0x00
